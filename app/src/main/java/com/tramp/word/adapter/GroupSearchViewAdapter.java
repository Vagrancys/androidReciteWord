...
public class GroupSearchViewAdapter extends AbsRecyclerViewAdapter{
    private ArrayList<BoardSearchInfo.List> Lists;
    public GroupSearchViewAdapter(RecyclerView recyclerView, ArrayList<BoardSearchInfo.List> lists){
        super(recyclerView);
        Lists=lists;
    }
