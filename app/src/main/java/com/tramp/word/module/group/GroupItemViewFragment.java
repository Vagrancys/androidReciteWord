 ...
 * version:1.0
 */
public class GroupItemViewFragment extends RxLazyFragment {
    ...
    public static GroupItemViewFragment newInstance(int itemStatus,int itemNumber){
        Bundle bundle=new Bundle();
        bundle.putInt(ConstantUtils.GROUP_ITEM_STATUS,itemStatus);
        bundle.putInt(ConstantUtils.GROUP_ITEM_NUMBER,itemNumber);
        GroupItemViewFragment fragment=new GroupItemViewFragment();
